 ...
 * under the License.
 */
package edu.sunyjcc.cas.web.flow;
 ...
 *
 */
public final class PasswordPolicyEnforcementWithExpirationCheckAction 
    extends AbstractAction implements InitializingBean {
    ...
    protected Event doExecute(final RequestContext context) throws Exception {
        ...
        try {
            ...
            String passwordExpString = "Authentication failed because account password has expired";
            if (this.logger.isErrorEnabled())
                this.logger.error(e.getMessage(), e);
            if (e.getMessage().contains(passwordExpString)) {
                returnedEvent = result("mustChangePassword");
            } else {
